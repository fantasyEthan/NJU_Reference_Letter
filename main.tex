...
\documentclass[12pt]{NJUletter}
\usepackage{fontspec} 
\setmainfont{Times New Roman}
\usepackage{tikz} 
\usepackage{xcolor}
	\definecolor{njupurple}{rgb}{0.4118,0.0275,0.3529}
\usepackage{lipsum}
\usepackage{fancyhdr}
\usepackage{lastpage}
\usepackage{eso-pic}
...
\textit{School of Electronic Science and Engineering}\\
Ph.D. Advisor, Professor\\
Nanjing University, Jiangsu, P.R.China\\
Email: **@nju.edu.cn
}
%
...
\def\Where{\hspace{-1.2mm}\textbf{\color{njupurple}%{njupurple}
Nanjing University
}} 
%%%%%%%%%%%%  Additional Contact Information %%%%%%%%%%%
%
% Set your preferred primary contact address here.
\def\Address{No.163, Xianlin Avenue\\
Qixia District,} 
%
\def\CityZip{Nanjing, 210043} 
%
% Set your FDU e-mail here
% \def\Email{\textbf{\color{njupurple}E-mail}: xxx@fudan.edu.cn}
%
% Set your preferred contact number here
\def\TEL{\textbf{\color{njupurple}Phone}: (86)-25-89683186}
%
% Set your department or personal website here
\def\URL{\textbf{\color{njupurple}URL}: http://www.nju.edu.cn/}
%
%%%%%%%%%%%%%%%%  Footer information  %%%%%%%%%%%%%%%%%%
%
...
\def\school{\small{
  NJU $\cdot$
     ~School of Electronic Science and Engineering $\cdot$
     ~No.163, Xianlin Avenue $\cdot$
     ~Nanjing, China P.R} } 
...
\begin{letter} {
              ...
              The University of ****\\ 
              Pokfulam, Hong Kong SAR, P.R.China\\ 
              }
